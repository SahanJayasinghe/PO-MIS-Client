                    ...
                    <div className="container">
                        <div className="row justify-content-around">
                            <div className="col-lg-8">
                                <MODeliveryForm customer="sender" loadDetails={this.loadDetails} />
                            </div>
                            {(mo_details)
                                ? <div className="col-lg-4">
                                    ...
                                    {(mo_details.status !== 'created')
                                        ...
                                        : (mo_details.is_return_expired)
                                            ? <div className="alert alert-danger ml-3 mt-4" role="alert">
                                                <h4 className="font-weight-bold mb-2 text-danger text-center text-uppercase">Expired</h4>
                                                <p className="d-flex text-center font-weight-bold ml-5">At {mo_details.return_expire_at}</p>
                                            </div>
                                            : <></>
                                    }
...
export default MoneyOrderReturn
