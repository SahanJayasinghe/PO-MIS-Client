    ...
    fetchRouteInfo = (id) => {
        ...
        axios.get(`${server_baseURL}/registered-post/route-info/${id}`, {headers})
            .then(res => {
                ...
                this.setState({
                    id,
                    return_route: res.data.return_route,
                    delivery_route: res.data.delivery_route
                });
            })
            .catch(err => {
                console.log(err);
                ...
                <Modal.Body>
                    <div className="row justify-content-center">
                        <div className="col-md-10">
                            {(this.state.return_route.length)
                                ? <>
                                    <h4 className="billing-heading mb-2 text-center text-info">Return Route</h4>
...
export default RegPostRouteInfo
